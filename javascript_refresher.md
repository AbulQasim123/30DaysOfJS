<div align="center">
  ...
  <h1> 30 Days Of JavaScript Refresher</h1>
  <a class="header-badge" target="_blank" href="https://www.linkedin.com/in/abulqasim-ansari-105b9722b/">
    <img src="https://img.shields.io/badge/style--5eba00.svg?label=LinkedIn&logo=linkedin&style=social">
  </a>

<sub>Author:
<a href="https://www.linkedin.com/in/abulqasim-ansari-105b9722b/" target="_blank">AbulQasim Ansari</a><br>
...
If you do not feel comfortable with data types check the following [link](https://github.com/AbulQasim/30-Days-Of-JavaScript/blob/master/02_Day_Data_types/02_day_data_types.md)
...
const names = ["AbulQasim", "Mathias", "Elias", "Brook"];
console.log(names.toString()); // AbulQasim,Mathias,Elias,Brook
```
...
console.log(names.join()); // AbulQasim,Mathias,Elias,Brook
console.log(names.join("")); //AbulQasimMathiasEliasBrook
console.log(names.join(" ")); //AbulQasim Mathias Elias Brook
console.log(names.join(", ")); //AbulQasim, Mathias, Elias, Brook
console.log(names.join(" # ")); //AbulQasim # Mathias # Elias # Brook
...
1. The following is an array of 10 students ages:
   ...
   1.Slice the first ten countries from the [countries array](https://github.com/AbulQasim/30DaysOfJavaScript/tree/master/data/countries.js)

1. Find the middle country(ies) in the [countries array](https://github.com/AbulQasim/30DaysOfJavaScript/tree/master/data/countries.js)
...
console.log(greetings("AbulQasim"));
```
...
```sh
{name: "AbulQasim", title: "Programmer", country: "Finland", city: "Helsinki"}
```
...
```sh
{name: "AbulQasim", title: "instructor", country: "Finland", city: "Helsinki"}
```
...
Check out there result on [codepen](https://codepen.io/AbulQasim/full/vYGqQxP)
